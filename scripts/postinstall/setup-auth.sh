...
case "$AUTH_PROVIDER" in
  clerk)
    ...
    mkdir -p "$PROJECT_DIR/app/(admin)/dashboard" "$PROJECT_DIR/app/(admin)/settings" "$PROJECT_DIR/app/(marketing)"
    copy_template "app/(admin)/layout.clerk.tsx" "$PROJECT_DIR/app/(admin)/layout.tsx"
    copy_template "app/(admin)/settings/page.clerk.tsx" "$PROJECT_DIR/app/(admin)/settings/page.tsx"
    copy_template "app/(marketing)/layout.clerk.tsx" "$PROJECT_DIR/app/(marketing)/layout.tsx"
  ...
  authjs)
    ...
    copy_template "app/(admin)/settings/page.authjs.tsx" "$PROJECT_DIR/app/(admin)/settings/page.tsx"
    copy_template "components/admin/user-menu-authjs.tsx" "$PROJECT_DIR/components/admin/user-menu-authjs.tsx"
    copy_template "app/(marketing)/layout.authjs.tsx" "$PROJECT_DIR/app/(marketing)/layout.tsx"
